...
export const PhysicalStats = ({ onContinue, navigation }: PhysicalStatsProps) => {
  ...
  const handleContinue = () => {
    ...
    if (isHeightValid && isWeightValid && onContinue) {
      ...
      if (weight) {
        stats.weight_kg = lbsToKg(parseFloat(weight));
      }
      ...
      >
        ...
        >
          ...
          <View style={styles.header}>
            <Text style={styles.title}>Physical Stats (Optional)</Text>
            <Text style={styles.subtitle}>
              Help other players understand your physical appearance
            </Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  progressBarFill: {
    width: '60%', // 60% for step 4 of ~5 steps
    height: '100%',
