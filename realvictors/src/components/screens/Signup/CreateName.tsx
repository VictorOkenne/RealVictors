        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.content}>
            <View style={styles.titleSection}>
              ...
              <Text style={styles.subtitle}>Enter a your full name and a username and your date of birth</Text>
            </View>
            ...
            <View style={styles.formSection}>
              ...
              <View style={styles.inputContainer}>
                <TextInput
                  style={[
                    styles.inputField,
                    (fullNameActive || fullName) && !fullNameError && styles.inputFieldActive,
                ...
                />
                {fullNameError && fullNameErrorMsg && <Text style={styles.errorText}>{fullNameErrorMsg}</Text>}
              </View>
              ...
              <View style={styles.inputContainer}>
                <TextInput
                  style={[
                    styles.inputField,
                    (usernameActive || username) && !usernameError && styles.inputFieldActive,
                    usernameError && styles.inputFieldError,
                  ]}
                ...
                />
                {usernameError && usernameErrorMsg && <Text style={styles.errorText}>{usernameErrorMsg}</Text>}
              </View>
              ...
              <TouchableOpacity
                style={[
                  ...
                  isFormValid && !fullNameError && !usernameError ? styles.continueButtonActive : styles.continueButtonInactive,
                ]}
