/**
 * TopPerformersCarousel Component
 *
...
import { TopPerformerCard, TopPerformerData } from './TopPerformerCard';

interface TopPerformersCarouselProps {
  players: TopPerformerData[];
  sport?: SportType;
...
export const TopPerformersCarousel: React.FC<TopPerformersCarouselProps> = ({
  players,
  sport = 'soccer',
  onPlayerPress,
}) => {
