/**
 * PlayerRankSection Component
 *
 * Displays player rankings with scope filter (league/location)
 */

import React, { useMemo, useState } from 'react';
import { StyleSheet, Text, TouchableOpacity, View } from 'react-native';
import { BORDER_RADIUS, COLORS, TYPOGRAPHY } from '../../../constants';
import { PlayerRanking, RankingScope } from '../../screens/UserProfilePage/mockData';
import { FilterIcon } from '../../icons/FilterIcon';
import { FilterModal, FilterSection, FilterState } from '../AppWide/FilterModal';

interface PlayerRankSectionProps {
  rankingsByScope: Record<RankingScope, PlayerRanking[]>;
}
    ...
    <View style={styles.container}>
      ...
      <View style={styles.headerContainer}>
        <View style={styles.titleContainer}>
          ...
          <Text style={styles.title}>Player Rank</Text>
        </View>
        <TouchableOpacity
...
export default PlayerRankSection;
